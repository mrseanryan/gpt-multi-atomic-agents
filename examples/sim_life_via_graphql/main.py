...
def run_chat_loop(test_prompt: str|None = None) -> list:
    ...
    return main_service.run_chat_loop(agent_definitions=agent_definitions, chat_agent_description=CHAT_AGENT_DESCRIPTION, _config=_config, given_user_prompt=test_prompt)
