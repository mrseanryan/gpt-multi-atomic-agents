...
// @ts-ignore
import { createPostFromDiscriminatorValue, serializePost, type Post } from '../models/index.js';
// @ts-ignore
import { PostItemRequestBuilderRequestsMetadata, type PostItemRequestBuilder } from './item/index.js';
// @ts-ignore
